# flake.nix
#
# This file packages pythoneda-shared-artifact/code-events as a Nix flake.
#
# Copyright (C) 2023-today rydnr's pythoneda-shared-artifact-def/code-events
#
...
{
  description = "Nix flake for pythoneda-shared-artifact/code-events";
  inputs = rec {
    ...
    pythoneda-shared-code-requests-events = {
      ...
      url = "github:pythoneda-shared-code-requests-def/events/0.0.79";
    };
    pythoneda-shared-code-requests-shared = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-code-requests-def/shared/0.0.74";
    };
    pythoneda-shared-pythonlang-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "code-events";
        version = "0.0.9";
        sha256 = "09r453h0h1y4aah6g909j6wg5ivkd80by3fi1lmj4sm1by4kc3pn";
        pname = "${org}-${repo}";
        pythonpackage = "pythoneda.shared.artifact.events.code";
        package = builtins.replaceStrings [ "." ] [ "/" ] pythonpackage;
        pkgs = import nixpkgs { inherit system; };
        description = "Events used to transform artifact events into code";
        ...
        pythoneda-shared-artifact-code-events-for = { python
          , pythoneda-shared-code-requests-events
          , pythoneda-shared-code-requests-shared
          , pythoneda-shared-pythonlang-domain }:
          let
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-code-requests-events} ${pythoneda-shared-code-requests-shared} ${pythoneda-shared-pythonlang-domain}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-shared-artifact-code-events-python312;
          pythoneda-shared-artifact-code-events-python39 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python39
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-shared-artifact-code-events-python39;
          ...
          pythoneda-shared-artifact-code-events-python310 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-artifact-code-events-python310;
          ...
          pythoneda-shared-artifact-code-events-python311 =
            shared.devShell-for {
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-artifact-code-events-python311;
          ...
          pythoneda-shared-artifact-code-events-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-artifact-code-events-python313;
        ...
        packages = rec {
          default = pythoneda-shared-artifact-code-events-python312;
          pythoneda-shared-artifact-code-events-python39 =
          ...
          pythoneda-shared-artifact-code-events-python313 =
            pythoneda-shared-artifact-code-events-for {
              python = pkgs.python313;
              pythoneda-shared-code-requests-events =
                pythoneda-shared-code-requests-events.packages.${system}.pythoneda-shared-code-requests-events-python313;
              pythoneda-shared-code-requests-shared =
